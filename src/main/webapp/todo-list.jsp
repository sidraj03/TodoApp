...
<%@page import="com.todoapp.web.TodoController" %>
...
<body>
 ...
 <th>Actions</th>
  ...
  <tr>
   <td> <c:out value="${todo.getTitle()}"></c:out> </td>
    <td> <c:out value="${todo.getTargetdate()}"></c:out> </td>
    <td> <c:out value="${todo.isStatus()}"></c:out> </td>
